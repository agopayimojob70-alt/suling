//=============================================================================
// MOG_HPGauge.js (修改版 - 所有敌人始终显示血条，死亡后消失)
//=============================================================================

/*:
 * @plugindesc (v1.4 *) Apresenta um medidor de HP do alvo. (Mod: Always show enemy HP)
 ...
 *
 * ============================================================================
 * - MODIFIED: Always show enemy HP gauge (hide on death)
 * ============================================================================
 */
...
HPGaugeSprite.prototype.forceVisible = function() {
	 ...
	 if (this._selectionHP && this.battler() == $gameTroop.aliveMembers()[window.targetEnemy] && !this.battler().isDead()) {return true};
	 return false;
};
