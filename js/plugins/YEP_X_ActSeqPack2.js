 ...
 * 动作序列包 2 插件是 Yanfly 引擎的扩展插件
 * 插件的战斗引擎核心。
 *
 * 此扩展插件包含用于自定义的更多基本功能
 * 视觉尺度上的动作序列。这个插件专注于制作战斗者
 * 执行视觉操作。
 *
 * ============================================================================
 ...
 * OPACITY target: x%, (frames)
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *将目标的不透明度更改为 x (0-255) or x% (0% to 100%). If you
 * use 'frames', 这将是不透明度更改的帧持续时间
 * the target.
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 * 使用示例： opacity user: 50%, 30
 *                opacity not focus: 0
 *=============================================================================
 *
 *=============================================================================
 * SHOW BATTLE HUD
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 * 如果使用“隐藏战斗 hud”隐藏战斗 hud，请使用此图显示
 * 战斗HUD回到玩家的屏幕。
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
